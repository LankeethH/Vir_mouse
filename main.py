...
def is_windows(landmark_list,thumb_index_dist):
    return(
...
def detect_gestures(frame, landmark_list, processed):
    if len(landmark_list) >= 21:
        ...
        elif  is_windows(landmark_list,thumb_index_dist ):
            pyautogui.hotkey('ctrl','shift','esc')
            cv2.putText(frame, "TaskManager", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)
